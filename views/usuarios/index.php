        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline card-primary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tablaUsuarios" class="table table-sm table-bordered table-hover table-striped" style="visibility: hidden;">
                            <thead>
                                <tr>
                                    <th>Nro</th>
                                    <th>Nombre</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if (isset($usuario['imagen'])): ?>
                                                <img src="<?= $URL; ?>public/uploads/usuarios/<?= $usuario['imagen']; ?>" loading="lazy" alt="Imagen" class="img-thumbnail" width="30">
                                            <?php else : ?>
                                                <img src="<?= $URL; ?>public/uploads/usuarios/user_default.jpg" loading="lazy" alt="Imagen" class="img-thumbnail" width="30">
                                            <?php endif; ?>
                                        </td>
